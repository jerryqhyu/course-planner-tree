...
class TermPlanner:
    ...
    def generate_schedule(self, selected_courses):
        ...
        if test_duplicate(selected_courses) == False:
            return []
        elif exist_in_tree(selected_courses) == False:
            return []
        else:
            ...
            while selected_courses != [] and selected_courses != pre_selected_courses:
...
#def return_tree(top_course,course_code):
    #if top_course.name == course_code:
        #return top_course
    #else:
        #for items in top_course.prereqs:
            #if return_tree(items, course_code):
                #return items
